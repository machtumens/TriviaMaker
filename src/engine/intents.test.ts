...
function makeState(): SessionState {
  return {
    ...
    teams: [
      { id: 'a', name: 'A', color: '#f00', score: 10, eliminated: false },
      { id: 'b', name: 'B', color: '#0f0', score: 20, eliminated: false },
    ],
...

{
  const EXPECTED: Array<Intent['type']> = [
    'setPhase', 'awardPoints', 'consumeQuestion', 'selectQuestion',
    'startClock', 'stopClock', 'eliminate', 'setStyleState', 'advanceRound',
  ]
  assert.deepEqual(
