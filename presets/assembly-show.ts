      ...
      categories: [

        {
          ...
          questions: [
            ...
            { id: 'w2', kind: 'text', points: 200, prompt: 'Which is the largest ocean on Earth?', answer: 'The Pacific Ocean', acceptedAnswers: ['Pacific'] },
        ...
        },
        {
          ...
          questions: [
            ...
            { id: 'wp4', kind: 'text', points: 400, prompt: 'What is the only common English word ending in the letters M-T?', answer: 'Dreamt' },
          ],
        },
        ...
        },
        {
          ...
          questions: [
            ...
            { id: 'h3', kind: 'text', points: 600, prompt: 'Who was the first woman to win a Nobel Prize?', answer: 'Marie Curie' },
        ...
        },
        {
          ...
          questions: [
            ...
            { id: 'sp4', kind: 'text', points: 800, prompt: 'Which country has won the most FIFA World Cups?', answer: 'Brazil' },
          ],
        },
        {
